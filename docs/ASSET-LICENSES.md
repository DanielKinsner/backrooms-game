...
| Pause button down | "Click-1" (FOUR Editors / Vintage SFX) | 200 Hz–7.5 kHz band, −3 dB, mono | `public/audio/ui/pause_down.ogg` |
| Pause button up | "Heavy-Click" (FOUR Editors / Vintage SFX) | trim 0.8 s, 180 Hz–6.5 kHz, −5 dB, mono | `public/audio/ui/pause_up.ogg` |

## Textures — generated by Daniel (project-internal)

From `NOCLIP_Backrooms_TexturePack_2K_UE5`, generated by Daniel Kinsner for
this project specifically. No external license applies. Shipped as 1K JPGs;
`_N_DirectX` normals are green-flipped to OpenGL convention at conversion.

| Set | Source folder | Local path |
|---|---|---|
